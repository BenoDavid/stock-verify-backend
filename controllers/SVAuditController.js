...
const { SVAudit } = db.sequelizeDb2.models;

class SVAuditController extends BaseController {
  constructor() {
    super(SVAudit);
  }
  async getAll(req, res) {
    try {
      ...
      const items = await this.model.findAndCountAll({
        ...
        include: [
          {
            model: this.model.associations.auditStock.target,
            as: "auditStock",
          },
        ],
        // order: sortOptions,
...
module.exports = new SVAuditController();
